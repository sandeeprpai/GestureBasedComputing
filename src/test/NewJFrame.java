 ...
 * NewJFrame.java
 *
 * Created on Feb 25, 2012, 1:41:06 PM
 */
package test;
...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public NewJFrame() {
        initComponents();
         setIconImage(Toolkit.getDefaultToolkit().createImage(getClass().getResource("/com/icon/colour_22.png")));
        jTextPane1.setContentType("text/html");
        String data = "<img src= \"http://tctechcrunch2011.files.wordpress.com/2011/09/timeline.png?w=640\" />";
